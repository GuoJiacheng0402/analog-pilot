...
> 姊妹项目：[DigitalPilot](https://github.com/GuoJiacheng0402/digital-pilot) —— 面向数字 IC 的 AI 智能体驱动 RTL-to-GDS 流程，覆盖 VCS、Design Compiler、Formality、Innovus、Calibre、StarRC、PrimeTime 与后仿 GLS。
